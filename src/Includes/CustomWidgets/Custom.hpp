...
namespace Custom {
	...
	inline void DrawBackground( bool Logged ) {
		...
		// Logo + Title
		{
			...
			ImVec2 TitleSize = Utils::CalcTextSize( g_Variables.m_FontNormal, g_Variables.m_FontNormal->FontSize, "Nexora V1.0" );
			draw->AddText( g_Variables.m_FontNormal, g_Variables.m_FontNormal->FontSize,
				ImVec2( pos.x + 80 - TitleSize.x / 2, pos.y + 92 ),
				ImGui::GetColorU32( ( ImVec4 ) g_Col.Base ), "Nexora V1.0" );
		}
	}
